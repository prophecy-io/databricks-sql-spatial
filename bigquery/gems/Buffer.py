            ...
            .addColumn(
                ...
                .addElement(
                   AlertBox(
                       ...
                       _children=[
                           Markdown(
                               "**This Gem uses BigQuery Spatial SQL features.**\n\n"
                               "For more information, see the [BigQuery Spatial Documentation](https://cloud.google.com/bigquery/docs/geospatial-data)."
                            )
                       ]
                   )   
                )  
