...
class SpatialInfo(MacroSpec):
    name: str = "SpatialInfo"
    projectName: str = "Andre_SQL_Project"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class SpatialInfoProperties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("SpatialInfo").addElement(
    ...
    def apply(self, props: SpatialInfoProperties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return SpatialInfo.SpatialInfoProperties(
