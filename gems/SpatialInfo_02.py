...
class SpatialInfo_02(MacroSpec):
    name: str = "SpatialInfo_02"
    projectName: str = "Andre_SQL_Project"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class SpatialInfo_02Properties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("SpatialInfo_02").addElement(
    ...
    def apply(self, props: SpatialInfo_02Properties) -> str:
        # Get the table name
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return SpatialInfo_02.SpatialInfo_02Properties(
