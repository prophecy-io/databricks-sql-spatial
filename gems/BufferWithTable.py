...
class BufferWithTable(MacroSpec):
    name: str = "BufferWithTable"
    projectName: str = "Andre_SQL_Project"
    category: str = "Spatial"
    minNumOfInputPorts: int = 1
    
    @dataclass(frozen=True)
    class BufferWithTableProperties(MacroProperties):
    ...
    def dialog(self) -> Dialog:
        ...
        return Dialog("BufferWithTable").addElement(
            ...
            .addColumn(
                ...
                .addElement(
                    SchemaColumnsDropdown("Distance column")
                        .bindSchema("component.ports.inputs[0].schema")
                        .bindProperty("distance_column_name")
                )                               
                .addElement(
    ...
    def apply(self, props: BufferWithTableProperties) -> str:
        # Get the table name
...
#             f"'{props.distance_column_name}'",            
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return BufferWithTable.BufferWithTableProperties(
            relation_name=parametersMap.get('relation_name'),
            schema=parametersMap.get('schema'),
            geom_column_name=parametersMap.get('geom_column_name'),
            distance_column_name=parametersMap.get('distance_column_name'),
